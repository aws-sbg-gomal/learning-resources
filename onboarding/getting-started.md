...
Welcome to **AWS SBG Gomal University**. This guide covers everything you need to get set up and make your first contribution.
...
Contact your track lead or the organization maintainer to be added to the GitHub organization:

- GitHub: [@i-arshii](https://github.com/i-arshii)
- Email: [awscloudclub.gu@gmail.com](mailto:awscloudclub.gu@gmail.com)

Specify which track you are joining:
- Cloud & DevOps
- AI & Machine Learning
...
Follow the [AWS Environment Setup guide](./aws-environment-setup.md) to configure your AWS account, CLI, and IAM credentials before working on any cloud project.

---

## Step 4: Set Up Git

If you have not used Git before or need a refresher, read the [Git Workflow Guide](./git-workflow-guide.md). It covers the exact branching and commit conventions used in this organization.
...
## Step 5: Explore Your Track Repository

Navigate to your track repository and read its README:
...
1. Copy the `_templates/` folder from your track repository into `projects/`.
...
- **Announcements** — for org-wide updates from maintainers
